...
namespace XMinecraftSuite.Core.Providers.Mod
{
    ...
    public interface IModProvider
    {
        ...
        /// <returns></returns>
        public Task<List<AbstractModSearchResult>> Search(string? modName = null, int limit = 0, int offset = 0,
            SearchSortRule order = SearchSortRule.None, string[]? gameVersions = null,
        ...
        /// <returns></returns>
        public Task<List<AbstractModVersion>> ModVersions(string slug, EnumModLoader[]? modLoaders = null,
