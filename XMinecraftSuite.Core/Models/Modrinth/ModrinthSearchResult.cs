...
public sealed class ModrinthSearchResult : AbstractModSearchResult
{
    ...
    public override EnumModLoader[] ModLoaders
    {
        get
        {
            ...
            if (Categories_.Contains("fabric")) modLoaders.Add(EnumModLoader.Fabric);
            if (Categories_.Contains("forge")) modLoaders.Add(EnumModLoader.Forge);
            if (Categories_.Contains("quilt")) modLoaders.Add(EnumModLoader.Quilt);
